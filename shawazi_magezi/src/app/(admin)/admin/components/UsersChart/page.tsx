...
//   const totalSellers = usersData ? usersData.filter(user => user.role === 'seller').length : 0;
//   const totalBuyers = usersData ? usersData.filter(user => user.role === 'buyer').length : 0;
//   const totalLawyers = usersData ? usersData.filter(user => user.role === 'lawyer').length : 0; 
