...
const BuyerPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const intervalId = setInterval(fetchBuyerAgreements, 30000);
  ...
  const transformToFormData = (agreement: AgreementType): AgreementFormData => {
    return {
      ...
      installment_schedule: agreement.installment_schedule || 0,
      penalties_interest_rate: agreement.penalties_interest_rate || 0,
    ...
    <div className="p-6 max-w-4xl mx-auto">
        ...
        {activeTab === 'details' && (
          <div className="p-6">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-semibold">Your Most Recent Agreement</h2>
              <button
            ...
            {recentAgreement ? (
              <div className="space-y-4">
                ...
                >
                  {recentAgreement.buyer_agreed ? 'Agreement Already Reviewed' : 'Review and Agree'}
                </button>
              </div>
            ) : (
      ...
      {showPopup && recentAgreement && (
        <ContractReviewPopup
          ...
          onAgreementUpdate={fetchBuyerAgreements}
