...
//     const sessionToken = localStorage.getItem('sessionToken'); // Optionally check for a session token

//     if (!isLoggedIn || !sessionToken) {
//       // If not authenticated, redirect to login
//       router.push('/login');
//     } else {
//       setIsAuthenticated(true); // Set authentication to true if localStorage values are valid
//     }
//   }, [router]);
...
//                     )}
//                     <h3 className="text-lg font-semibold">{land.location_name}</h3>
//                     <p className="text-sm text-gray-600">{land.address}</p>
//                     <p className="text-md font-bold">{land.price}</p>
//                     <button
...
//                   </div>
//                 ))
//               : !loading && <p>No land details available.</p>}
//           </div>
