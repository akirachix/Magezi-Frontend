...
// Lawyer_agree/page.tsx

"use client"; // Add this line at the top to make this file a Client Component
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-md">
        {activeTab === 'details' ? (
          <div className="p-6">
            <h2 className="text-2xl font-semibold mb-6">Agreement Details</h2>
            ...
            {recentAgreement ? (
              <div className="space-y-4">
                <p><strong>Parcel Number:</strong> {recentAgreement.parcel_number || "N/A"}</p>
                <p><strong>Price:</strong> Ksh {recentAgreement.agreed_amount?.toLocaleString() || "N/A"}</p>
                <p><strong>Contract Duration:</strong> {recentAgreement.contract_duration} months</p>
                <p><strong>Down Payment:</strong> Ksh {recentAgreement.down_payment?.toLocaleString() || "N/A"}</p>
                <p>
                  <strong>Buyer Status:</strong>
                ...
                <button
                  onClick={handleShowPopup}
                  className="mt-6 w-full px-4 py-2 bg-hover text-white rounded hover:bg-customGreen transition duration-300 ease-in-out"
                >
                  Review Agreement
                </button>
              </div>
