...
// const CreateAgreement: React.FC<CreateAgreementProps> = ({ userRole }) => {
...
import Sidebar from "../components/Sidebar";
import { FormData } from "@/app/utils/types";
import { useNewAgreements } from "@/app/Hooks/userNewAgreenments"; // Corrected import
...
// const CreateAgreement: React.FC = () => {
//   const router = useRouter();
//   const { loading, error } = userNewAgreements();
//   const [submitting, setSubmitting] = useState(false);
//   const [submitError, setSubmitError] = useState<string | null>(null);
