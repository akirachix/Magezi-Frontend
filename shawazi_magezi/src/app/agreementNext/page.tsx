...
// // type UserRole =  ""|"lawyer" | "buyer" | "seller";
// type UserRole = 'buyer' | 'seller' | 'lawyer' | '';
...
//   const [userRole, setUserRole] = useState<UserRole>(""); // Empty string as initial value
...
//   //     setUserRole(existingRole as UserRole); // Safely cast to UserRole
//   //   }
//   // }, []);
...
//   return (
//     <div className="flex">
//       <SideBar userRole={userRole} /> {/* Pass userRole correctly */}
...
//                 <input
//                   type="checkbox"
//                   checked={term.id ? checkedTerms[term.id] || false : false}
...
//                   } // Convert term.id to string
//                   onChange={() => {
//                     if (term.id !== undefined) {
//                       handleTermCheck(String(term.id)); // Convert term.id to string
//                     }
//                   }}
//                   className="form-checkbox h-5 w-5 text-green-600"
//                 />
