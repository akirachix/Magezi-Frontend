...
const Sidebar = () => {
    ...
    const menuItems = [
        ...
        { name: 'Contracts', icon: <LiaFileContractSolid className="w-8 h-8 mr-4"/>, href: '/contracts' },
        { name: 'Payments', icon: <MdOutlinePayments className="w-8 h-8 mr-4"/>, href: '/payments' },
        { name: 'Users', icon: <LuUsers2 className="w-8 h-8 mr-4"/>, href: '/users' },
    ];
