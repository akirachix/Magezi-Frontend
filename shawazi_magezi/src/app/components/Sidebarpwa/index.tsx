...
// interface SideBarProps {
//   userRole: 'seller' | 'buyer' | 'lawyer' | undefined;
//   userType: 'seller' | 'buyer' | 'lawyer' | undefined;
// }

// const SideBar: React.FC<SideBarProps> = ({ userRole, userType }) => {
//   const [isOpen, setIsOpen] = useState(false);
//   const [showSettings, setShowSettings] = useState(false);
//   const [showSidebar, setShowSidebar] = useState(false);
//   const pathname = usePathname();
...
//   const getRoutes = useCallback((role: string) => {
//     const validRole = roleSpecificRoutes[role] ? role : 'sr';
//     return roleSpecificRoutes[validRole];
//   }, []);
...
//   const routes = getRoutes(userRole || userType || 'seller');
...
//       },
//       { 
//         name: `${userRole?.charAt(0).toUpperCase()}${userRole?.slice(1)} Profile`, 
//         icon: <FaUser className="w-5 h-5 mr-2" />, 
//         href: '/profile' 
//       },
//       { 
//         name: 'ChatRoom', 
//         icon: <FaComments className="w-5 h-5 mr-2" />, 
//         href: '/chatroom' 
//       },
//       { 
//         name: `${userRole?.charAt(0).toUpperCase()}${userRole?.slice(1)} Contract`, 
//         icon: <FaFileContract className="w-5 h-5 mr-2" />, 
//         href: routes.contract 
//       },
//       { 
//         name: 'Transactions', 
//         icon: <FaMoneyCheck className="w-5 h-5 mr-2" />, 
...
//   const getRoutes = useCallback((role: 'seller' | 'buyer' | 'lawyer' | undefined) => {
...
//   const routes = getRoutes(userRole || userType);
