...
// import { loginUser, saveUserToDatabase } from "../utils/userLogin"; // Updated function import
...
//         .matches(/^\+254\d{9}$|^254\d{9}$/, 'Phone number must start with +254 or 254 followed by 9 digits')
...
//                     await saveUserToDatabase(loginResponse.user);
//                 }
