  ...
  const onSubmit = async (data: UserSignup) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Check if the error message relates to phone number uniqueness
        if (
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col font-jost justify-center relative overflow-hidden">
      ...
      <div className="w-full md:w-[40%] mx-auto z-10 bg-white p-6 md:p-8 rounded-lg shadow-lg">
        <h2 className="text-2xl md:text-3xl font-bold text-center text-primary mb-6 md:mb-8">
          Sign Up
        </h2>
        ...
        >
          <div>
            <label
              htmlFor="first_name"
              className="block text-lg md:text-xl font-medium text-primary mb-1"
            >
            ...
            <input
              id="first_name"
              {...register("first_name")}
              className={`w-full border text-[16px] md:text-[20px] ${
                errors.first_name ? "border-border-color" : "border-foreground"
              } border-2 rounded-md shadow-sm p-3 focus:outline-none focus:ring-1 focus:ring-foreground`}
            />
            {errors.first_name && (
          ...
          <div>
            ...
            <input
              ...
              {...register("last_name")}
              className={`w-full border text-[16px] md:text-[20px] ${
                errors.last_name ? "border-border-color" : "border-foreground"
              } border-2 rounded-md shadow-sm p-3 focus:outline-none focus:ring-1 focus:ring-foreground`}
            />
            {errors.last_name && (
              <p className="mt-1 text-xs text-border-color">
          ...
          <div>
            <label
              htmlFor="password"
              className="flex items-center text-lg md:text-xl font-medium text-primary mb-1"
            >
            ...
            <div className="relative">
              <input
                ...
                {...register("password")}
                className={`w-full border text-[16px] md:text-[20px] ${
                  errors.password ? "border-border-color" : "border-foreground"
                } border-2 rounded-md shadow-sm p-3 focus:outline-none focus:ring-1 focus:ring-foreground`}
              />
              <button
                type="button"
          ...
          <div>
            ...
            <select
              ...
              {...register("role")}
              className={`w-full border text-[16px] md:text-[20px] ${
                errors.role ? "border-border-color" : "border-foreground"
              } border-2 rounded-md shadow-sm p-3 focus:outline-none focus:ring-1 focus:ring-foreground`}
            >
          ...
          <button
            type="submit"
            className={`w-full py-3 text-lg md:text-xl font-medium text-white bg-primary rounded-md ${
              loading
